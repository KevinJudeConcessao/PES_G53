...
private:
  ...
  ExprResult ParseCXXReflectExprExpression();
  ExprResult ParseCXXReflectionQueryExpression();

  //===--------------------------------------------------------------------===//
  // C++ Meta Constructs Support
#if 0
  StmtResult ParseLoopUnrollStatement();
...
private:
  //===--------------------------------------------------------------------===//
  // Clang extensions - user controlled errors and warnings
  StmtResult ParseClangDiagnosticsStatement();
};
