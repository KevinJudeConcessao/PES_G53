...
Parser::ParseExprAfterUnaryExprOrTypeTrait(const Token &OpTok,
  ...
  assert(OpTok.isOneOf(tok::kw_typeof, tok::kw_sizeof, tok::kw___alignof,
                       ...
                       tok::kw___builtin_omp_required_simd_align, tok::kw_reflect_expr) &&
         "Not a typeof/sizeof/alignof/vec_step/reflect_expr expression!");
  ...
  if (Tok.isNot(tok::l_paren)) {
    ...
    if (OpTok.isOneOf(tok::kw_sizeof, tok::kw___alignof, tok::kw_alignof,
                      tok::kw__Alignof, tok::kw_reflect_expr)) {
    ...
    isCastExpr = false;
    if (OpTok.isOneOf(tok::kw_typeof, tok::kw_reflect_expr) && !getLangOpts().CPlusPlus) {
...
/// \brief Parse a sizeof or alignof or reflect_expr expression.
///
/// \verbatim
///       unary-expression:  [C99 6.5.3]
///         'sizeof' unary-expression
...
ExprResult Parser::ParseUnaryExprOrTypeTraitExpression() {
  ...
  else if (OpTok.is(tok::kw_reflect_expr))
    ExprKind = UETT_ReflectExpr;
