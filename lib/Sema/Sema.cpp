...
Sema::Sema(Preprocessor &pp, ASTContext &ctxt, ASTConsumer &consumer,
    ...
    : ExternalSource(nullptr), isMultiplexExternalSource(false),
      ...
      CXXTypeInfoDecl(nullptr), StdReflectionNamespace(nullptr), ReflectionEnumDecl(nullptr),
      MetaEnumConstantDecl(nullptr), StdStringViewCache(nullptr),
      StdTupleTemplate(nullptr), MSVCGuidDecl(nullptr), NSNumberDecl(nullptr),
